...
1. `ai_and_agents/claude_code_loops_and_scheduling.md` — /loop for session-bound recurring prompts (3-day max), /schedule for persistent automation, Google Workspace CLI for full Drive/Docs/Sheets access
